...
class WhatsAppNotifier:
    ...
    async def notificar_prospecto(self, prospect: Dict[str, Any]) -> bool:
        ...
        """
        # Senior Rule: Obtener gancho técnico si existe
        audit = prospect.get("audit_data", {})
        tecnico_hook = audit.get("gancho_venta", "Análisis no disponible")
    ...
    async def enviar_resumen_diario(self, stats: Dict) -> bool:
        ...
        resumen = f"""📊 *RESUMEN DIARIO — {self.config.COMPANY_NAME} Agent*
━━━━━━━━━━━━━━━━━━━━━━
...
🤖 _{self.config.COMPANY_NAME} Agent activo_"""

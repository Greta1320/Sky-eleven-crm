...
class Config:
    ...
    TEMPLATE_WSP_ALERTA: str = """🚀 *NUEVO PROSPECTO HOT — SKY Eleven*
...
En SKY Eleven ayudamos a negocios como el tuyo a conseguir más clientes con sitios web profesionales y estrategias digitales efectivas.
...
Noté que muchos clientes potenciales no los encuentran fácilmente en Google. En SKY Eleven tenemos una propuesta que les ayudaría muchísimo a conseguir más clientes.

¿Les cuento más? Solo toma 5 minutos 🚀"""

    TEMPLATE_SEGUIMIENTO: str = """Hola {contacto} 👋

Te escribo de nuevo de SKY Eleven. 
